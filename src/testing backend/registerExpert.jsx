...
export const TestingRegisterExpert = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        const data = new Expert("Micheila", "1231212131","eve@gmail.com", "GGWP123awda", tanggalLahir, "male", "SMA", "02uTj3FZzbhDVd7dOiH1", "2132132131", "Mandiri", ktp, certificates, profilePicture)
